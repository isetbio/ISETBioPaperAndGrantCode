...
%{
    ...
    HDRimageName = struct(...
        ...
        'temporalFrequencyHz', 16.0, ...         % Croner & Kaplan: 4 Hz
        'contrast', 0.5, ...                   % Croner & Kaplan: 25%
        'coneContrasts', [1 1 1], ...
        'backgroundLuminanceCdM2', 40, ...      % Croner & Kaplan: 40cd/m2
    ...
    photocurrentParams = struct(...
        'osBiophysicalModelWarmUpTimeSeconds',  4.0, ...
    ...
    % What to do:
    % Stage 1: input cone mosaic responses
...
arguments
    ...
    options.HDRimageName = [];  % either the name of an HDR scene, (e.g., 'scene1') or a stuct with stim params
    ...
    if (isstruct(HDRimageName))
        ...
        theDataFileName = sprintf('CRT_%s_%1.0fHz_%1.0fCPD_%2.0fCdM2_%1.2fcontrast_allData.mat', ...
            HDRimageName.type, ...
            HDRimageName.temporalFrequencyHz, ...
            HDRimageName.spatialFrequencyCPD, ...
            HDRimageName.backgroundLuminanceCdM2, ...
            HDRimageName.contrast);
    else
        theDataFileName = sprintf('HDR_%s_%2.0fCdM2_allData.mat', HDRimageName, sceneCropParams.meanLuminanceCdM2);
    end


    % Phase 1 - compute input cone mosaic responses
    ...
    if (isstruct(HDRimageName))
        ...
        figureFormatForStaticResponseTimeSeries = '1x1 standard very wide figure';

...
%{
    ...
    innerRetinaFilterDerivationParams = struct(...
        ...
        'componentFitted', 'complexSpectrumWithBiasForAmplitudeSpectrum', ... % choose between {'complexSpectrum', 'amplitudeSpectrumOnly', 'complexSpectrumWithBiasForAmplitudeSpectrum'}
...
shortTargetCellImpulseResponseSource = strrep(strrep(strrep(strrep(targetCellImpulseResponseSource, 'Benardete&Kaplan 1997, ', ''), ' ', '_'), ',', ''), 'Figure_', 'Fig');
theAnalyzedTTFsFileName = fullfile(TTFsubDir, sprintf('IR_%d_%s_%s.mat', synthesizeMRGCtemporalFiltersForRGCwithIndex, shortTargetCellImpulseResponseSource, postFix));

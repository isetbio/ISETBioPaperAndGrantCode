...
%{
    ...
    innerRetinaFilterDerivationParams = struct(...
        'temporalFilterSynthesisMethod', 'differenceOfLowPassFilters', ... % choose between {'direct division of TTFs', 'differenceOfLowPassFilters', and other filter types}
        'minFrequencyHzWithUnitWeight', 0.0, ...

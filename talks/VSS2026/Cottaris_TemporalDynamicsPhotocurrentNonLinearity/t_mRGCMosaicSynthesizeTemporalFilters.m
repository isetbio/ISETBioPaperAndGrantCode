...
%{
    ...
    innerRetinaFilterDerivationParams = struct(...
        ...
        'componentFitted', 'complexSpectrum', ... % choose between {'complexSpectrum', 'amplitudeSpectrumOnly'}
        ...
        'solverType',  'multiStartsNum', ... % choose from {'fmincon'; 'global-search'; 'multi-start'}
        'multiStartsNum', 128, ...
        'useParallel', ~true);

...
targetRGCpositionDegs = [-6.082 -0.047];
[~,targetRGCindex] = min(sum(bsxfun(@minus, theMRGCmosaic.rgcRFpositionsDegs,targetRGCpositionDegs).^2,2));
...
theMRGCmosaic.visualize(...
    ...
    'plotTitle', sprintf('min center weight visualized: %2.3f', minCenterConeWeight), ...
    'withFigureFormat', ff, ...
    'labelRGCsWithIndices', targetRGCindex, ...
